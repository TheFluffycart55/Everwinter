package net.thefluffycart.everwinter.item.custom;
...
public class FrozenTuskItem extends Item {
    private final TagKey<Instrument> instrumentTag;

    public FrozenTuskItem(Item.Settings settings, TagKey<Instrument> instrumentTag) {
        super(settings);
